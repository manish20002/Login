...
<body>
    ...
    <button class="flex mx-auto mt-15 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg"><a href="./pasgen.php">Password Generate</a></button>
